...
This project is meant to show a set of simple experiments in order to explore the CGM of TNG galaxies.
...
![Test figure](images/single_halo_visualization_MgII_CIV.png)